...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: None after fix. Before fix: People with 1 turn were removed early because condition was >1 
    ...
    // Defect(s) Found: None after fix. Before fix: Same last-turn bug 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: None after fix. Before fix: People with 0 turns were not re-added 
    ...
    // Defect(s) Found: None after fix. Before fix: People with negative turns were not re-added 
    ...
    // Defect(s) Found: None after fix. Exception and message were already correct 
